const fs = require("fs");
const armorIds = require("./armorIds");
const armorTemplate = require("./armorTemplate");

function generateArmorDbFile(entries, filename) {
    let db = [];
    let templateParameters = armorTemplate.template.parameters;
...
exports.generateArmorDbFile = generateArmorDbFile;
